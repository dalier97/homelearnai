  ...
  <body class="bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          <div class="flex items-center space-x-8">
            ...
            {{-- Parent Navigation - Always visible for desktop, handled by mobile menu --}}
          ...
          <div class="flex items-center space-x-4">
            @if(auth()->check() && !session('kids_mode_active'))
            <!-- Mobile Menu Button -->
            <button @click="mobileMenuOpen = !mobileMenuOpen"
              ...
              <!-- Hamburger icon -->
              <svg :class="{'hidden': mobileMenuOpen, 'block': !mobileMenuOpen }" class="block h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="relative" x-data="{ open: false }">
              <button @click="open = !open" 
                ...
                <span class="text-sm">{{ auth()->user()->email ?? __('User') }}</span>
              ...
              <div x-show="open" 
                ...
                <div class="py-1">
                  ...
                  <div class="px-4 py-2 border-b border-gray-100">
                    ...
                    <p class="text-sm font-medium text-gray-900 truncate">{{ auth()->user()->email ?? __('User') }}</p>
                  </div>
    ...
    <div x-show="mobileMenuOpen" 
      ...
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <a href="{{ route('dashboard.parent') }}" 
           class="flex items-center space-x-2 px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('dashboard.parent') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50' }}"
        ...
        <a href="{{ route('children.index') }}" 
           class="flex items-center space-x-2 px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('children.*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50' }}"
           @click="mobileMenuOpen = false">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
          </svg>
        ...
        <a href="{{ route('subjects.index') }}" 
           class="flex items-center space-x-2 px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('subjects.*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50' }}"
           @click="mobileMenuOpen = false">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
          </svg>
        ...
        <a href="{{ route('planning.index') }}" 
           class="flex items-center space-x-2 px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('planning.*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50' }}"
           @click="mobileMenuOpen = false">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 0v10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2"/>
          </svg>
        ...
        <a href="{{ route('reviews.index') }}" 
           class="flex items-center space-x-2 px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('reviews.*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50' }}"
           @click="mobileMenuOpen = false">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
          </svg>
        ...
        <a href="{{ route('calendar.index') }}" 
           class="flex items-center space-x-2 px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('calendar.*') ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50' }}"
           @click="mobileMenuOpen = false">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
          </svg>
